...
const EXAM_DATA = {
  ...
  1: [
    ...
    {
      gr: 'να',
      en: 'to (subjunctive); here (you go)',
      cards: [
        { sentence: 'Θέλω να μάθω κιθάρα μέχρι το καλοκαίρι.', sentenceEn: 'I want to learn guitar by summer.' },
        {
          sentence: 'Να τα κλειδιά σου, τα βρήκα κάτω από τον καναπέ.',
          sentenceEn: 'Here are your keys, I found them under the sofa.',
        },
    ...
    // ── ο (rank 2): masculine article ──
    {
      ...
      cards: [
        {
          sentence: 'Ο γάτος κοιμάται πάνω στο πληκτρολόγιο ξανά.',
          sentenceEn: 'The cat is sleeping on the keyboard again.',
        },
        {
          sentence: 'Ο καφές κρύωσε ενώ μιλούσα στο τηλέφωνο.',
          sentenceEn: 'The coffee got cold while I was talking on the phone.',
        },
      ],
    },
    // ── θα (rank 4): future / conditional ──
    {
      ...
      cards: [
        {
          sentence: 'Θα πάμε διακοπές στην Κρήτη τον Αύγουστο.',
          sentenceEn: 'We will go on holiday to Crete in August.',
        },
        {
          sentence: 'Θα ήθελα ένα ποτήρι κρύο νερό, παρακαλώ.',
          sentenceEn: 'I would like a glass of cold water, please.',
        },
    ...
    // ── μου (rank 7): my / mine ──
    {
      ...
      cards: [
        {
          sentence: 'Η αδερφή μου σπουδάζει ιατρική στη Θεσσαλονίκη.',
          sentenceEn: 'My sister studies medicine in Thessaloniki.',
        },
    ...
    // ── με (rank 8): with / me ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Με τέτοιον καιρό δεν βγαίνω ούτε στο μπαλκόνι.',
          sentenceEn: "With this weather I don't even go out to the balcony.",
        },
      ],
    },
    // ── για (rank 9): for / about ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Μιλούσαμε για την ταινία που είδαμε χθες.',
          sentenceEn: 'We were talking about the film we saw yesterday.',
        },
    ...
    // ── εγώ (rank 11): I ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Ποιος έφαγε το τελευταίο κομμάτι; Εγώ δεν ήμουν!',
          sentenceEn: "Who ate the last piece? It wasn't me!",
        },
      ],
    },
    // ── τι (rank 12): what / how (exclamatory) ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Τι έγινε; Γιατί φωνάζουν οι γείτονες;',
          sentenceEn: 'What happened? Why are the neighbours yelling?',
        },
      ],
    },
    // ── σε (rank 13): to / in / at ──
    ...
    {
      gr: 'που',
      en: 'that, which, where (relative)',
      cards: [
        {
          sentence: 'Ο φίλος που μένει στο Βερολίνο έρχεται Ελλάδα.',
          sentenceEn: 'The friend that lives in Berlin is coming to Greece.',
        },
        {
          sentence: 'Η ταβέρνα που τρώγαμε μικροί έκλεισε.',
          sentenceEn: 'The taverna where we used to eat as kids closed down.',
        },
    ...
    // ── του (rank 16): his / its / him ──
    {
      ...
      cards: [
        {
          sentence: 'Το αυτοκίνητο του Κώστα χάλασε στον αυτοκινητόδρομο.',
          sentenceEn: "Kostas's car broke down on the motorway.",
        },
    ...
    // ── ότι (rank 18): that (complement) ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Μου είπε ότι αλλάζει δουλειά τον Σεπτέμβρη.',
          sentenceEn: "She told me that she's changing jobs in September.",
        },
      ],
    },
    ...
    // ── της (rank 20): her / hers ──
    {
      ...
      cards: [
        {
          sentence: 'Η φωνή της ακούγεται παντού στο σπίτι.',
          sentenceEn: 'Her voice can be heard everywhere in the house.',
        },
    ...
    // ── αλλά (rank 26): but ──
    {
      ...
      cards: [
        {
          sentence: 'Ήθελα να πάω στη γιορτή, αλλά αρρώστησα.',
          sentenceEn: 'I wanted to go to the party, but I got sick.',
        },
    ...
    // ── πως (rank 34): that (informal) ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Λέει πως δεν πρόλαβε να φάει μεσημέρι.',
          sentenceEn: "He says that he didn't have time to eat lunch.",
        },
      ],
    },
    ...
    // ── εκεί (rank 44): there ──
    {
      ...
      cards: [
        {
          sentence: 'Βλέπεις εκεί πέρα το βουνό; Εκεί πάμε.',
          sentenceEn: "See that mountain over there? That's where we're going.",
        },
    ...
    // ── όταν (rank 49): when (conjunction) ──
    {
      ...
      cards: [
        {
          sentence: 'Όταν ήμουν μικρός, παίζαμε στο δρόμο.',
          sentenceEn: 'When I was little, we played in the street.',
        },
    ...
    // ── μαζί (rank 50): together / with ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Πήρε μαζί της ομπρέλα γιατί βρέχει.',
          sentenceEn: "She took an umbrella with her because it's raining.",
        },
      ],
    },
    // ── πώς (rank 51): how (question) ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Πώς πας στη δουλειά, με μετρό ή λεωφορείο;',
          sentenceEn: 'How do you get to work, by metro or bus?',
        },
      ],
    },
    // ── ή (rank 57): or ──
    ...
    // ── τότε (rank 76): then ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Αν δεν θέλεις πίτσα, τότε τι θέλεις;',
          sentenceEn: "If you don't want pizza, then what do you want?",
        },
      ],
    },
    // ── μετά (rank 77): after ──
    ...
    // ── ίσως (rank 86): maybe ──
    {
      ...
      cards: [
        {
          sentence: 'Ίσως πάμε Πάρο φέτος αντί για Νάξο.',
          sentenceEn: "Maybe we'll go to Paros this year instead of Naxos.",
        },
        {
          sentence: 'Αυτό είναι ίσως το καλύτερο βιβλίο που διάβασα.',
          sentenceEn: "This is perhaps the best book I've read.",
        },
      ],
    },
    // ── όπως (rank 87): as / just as ──
    {
      ...
      cards: [
        {
          sentence: 'Κάντο όπως σου είπα, αλλιώς θα χαλάσει.',
          sentenceEn: "Do it as I told you, otherwise it'll break.",
        },
    ...
    // ── δύο (rank 94): two ──
    {
      ...
      cards: [
        ...
        {
          sentence: 'Περίμενε δύο λεπτά, πρέπει να κλείσω το φούρνο.',
          sentenceEn: 'Wait two minutes, I need to turn off the oven.',
        },
      ],
    },
    // ── έξω (rank 97): outside ──
